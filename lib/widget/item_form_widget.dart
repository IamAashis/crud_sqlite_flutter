...
class ItemFormWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    */
    ...
    /*   if (newItemModel.id != null) {
      print("From here From here");
      print(newItemModel.itemName);
      print(newItemModel.itemPrice);
      print(newItemModel.itemImage);
      ref.read(itemNameControllerProvider.notifier).state =
          newItemModel.itemName;
      ref.read(itemPriceControllerProvider.notifier).state =
          newItemModel.itemPrice;
      ref.read(temporaryImagePathProvider.notifier).state =
          newItemModel.itemImage;
    }*/
    ...
    Future<void> _pickImage(String source) async {
      ...
      if (pickedImage != null) {
        ...
        ref.read(temporaryImagePathProvider.notifier).state = pickedImage.path;
        // setState(() {
        // temporaryImagePath = pickedImage.path;
        // temporaryImagePath = pickedImage.path;
        // });
                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    if (newItemModel.id != null) {
                      ...
                      ref.read(itemListProvider.notifier).addItem(newItemModel);
                      // itemProvider.addItem(newItemModel);
                    }
                  }
                },
