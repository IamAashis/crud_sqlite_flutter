...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    Future<List<ItemModel>> getItemList() async {
      // List<ItemModel> itemList = await Provider.of<ItemListProvider>(context).getItemList();
      List<ItemModel> itemList = await itemListProvider
...
class HomePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<List<ItemModel>> getItemList() async {
      await ref.read(itemListProvider.notifier).fetchItemList();
